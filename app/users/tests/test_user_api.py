...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email': 'test@rendezvous.com', 'password': 'testpass'}
        create_user(**payload)
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_password_too_short(self):
        """Test that the password must be more then 5 chars"""
        payload = {'email': 'test@rendezvous.com', 'password': 'pw'}
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@rendezvous.rs', password='testpass')
        payload = {'email': 'test@rendezvous.rs', 'password': 'wrong'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_no_user(self):
        ...
        payload = {'email': 'test@rendezvous.rs', 'password': 'testpass'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_toke_missing_field(self):
        ...
        res = self.client.post(TOKEN_URL,
                               {'email': 'test@rendezvous.rs', 'password': ''})
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        ...
        payload = {'first_name': 'new name', 'password': 'newpassword1223'}
